...
# ==========================================
# Load .env if present locally, but prioritize system/Railway environment variables
load_dotenv()
...
# Validate required variables for Railway Deployment
if not TOKEN:
    raise ValueError(
...
print("--------------------------------------------------")
print("Railway Deployment Environment Config:")
...
try:
    ...
    print("RapidOCR not found. Falling back to EasyOCR with low-memory optimizations...")
    import easyocr
...
def process_batch(chat_id, user_id, format_type, images):
    ...
    # 2. Process images (OCR + QR decoding)
